...
class levelOne extends Phaser.Scene {
    ...
    this.bombtimer = this.time.addEvent({delay: Phaser.Math.Between(8000, 12000), callback:this.spawnBomb, callbackScope:this});
    ...
    spawnBomb() {
      ...
      var bomb = this.bombs.create(800, 450, "bomb");
      bomb.setBounce(1);
      bomb.setCollideWorldBounds(false);
      bomb.setVelocity(Phaser.Math.Between(-200, -100), 100);
      this.physics.add.overlap(this.player, bomb, (x,y) => this.hitBomb(x,y));
      this.bombtimer = this.time.addEvent({delay: Phaser.Math.Between(8000, 12000), callback:this.spawnBomb, callbackScope:this});
    }
